...
use crate::mail::mail_message::MailMessage;
use crate::mail::mime_message::MimeMessage;
use crate::mail::mime_message_helper::MimeMessageHelper;
...
impl MailMessage for MimeMailMessage {
        ...
        T: Into<String>,
    {
        ...
        self.helper.set_reply_to(&reply_to).map_err(|error| {
            MailError::ParseError(error.to_string())
        })
    }
