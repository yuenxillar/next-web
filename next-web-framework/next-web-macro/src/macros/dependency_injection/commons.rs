...
use crate::macros::dependency_injection::field_or_argument_attr::FieldOrArgumentAttr;
use super::{color::Color, scope::Scope};
...
pub(crate) fn generate_create_provider(scope: Scope, color: Color) -> TokenStream {
    match (scope, color) {
        ...
        (Scope::Prototype, Color::Async) => quote! {
            prototype_async
        },
        (Scope::Prototype, Color::Sync) => quote! {
            prototype
        },
