...
impl LunarCalendar {
    pub fn new() -> Self {
        LunarCalendar {
            ...
            solar_term_base: vec![
                6.11, 20.84, 4.6295, 19.4599, 6.3826, 21.4155, 5.59, 20.888, 6.318, 21.86, 6.5,
                22.20, 7.928, 23.65, 8.35, 23.95, 8.44, 23.822, 9.098, 24.218, 8.218, 23.08, 7.9,
                22.6,
            ],
        }
    }
    ...
    pub fn get_lunar_date(&self, date: NaiveDate) -> String {
        ...
        for j in 0..13 {
            ...
            if leap_month > 0 && j == leap_month {
                is_leap = true;
                let days = if (lunar_info >> (16 + leap_month)) & 0x1 == 1 {
                    30
                } else {
                    29
                };
            ...
            // 计算正常月天数
            let month_days = if (lunar_info >> (16 - j)) & 0x1 == 1 {
                30
            } else {
                29
            };
        ...
        format!(
            "{}{}年{}{}",
            self.heavenly_stems[gan_index], self.earthly_branches[zhi_index], month_str, day_str
        )
    }
    ...
    fn lunar_year_days(&self, year: i32) -> u32 {
        ...
        if leap_month > 0 {
            sum += if (lunar_info >> (16 + leap_month)) & 0x1 == 1 {
                30
            } else {
                29
            };
